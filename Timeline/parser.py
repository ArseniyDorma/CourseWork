...
plt.xlabel('Время')
plt.ylabel('RMS, g')
plt.title('Рисунок 2.1 - Динамика RMS по всем каналам', fontweight='bold')
...
plt.xlabel('Время')
plt.suptitle('Рисунок 2.2 - Каналы с наибольшим ростом RMS', fontsize=14, fontweight='bold')
plt.tight_layout()
...
print("\nТаблица 2.1 - Статистики по каналам (первые 10):")
...
plt.suptitle('Рисунок 2.3 - Распределение RMS по каналам', fontsize=14, fontweight='bold')
plt.tight_layout()
...
print("\nТаблица 2.3 - Выбросы по правилу 3σ (первые 10 каналов):")
...
plt.title('Рисунок 2.4 - Диаграмма размаха RMS (первые 15 каналов)', fontsize=14, fontweight='bold')
plt.xlabel('Канал')
plt.ylabel('RMS, g')
...
print("Таблица 2.5 - Корреляционная матрица признаков:")
...
plt.title('Рисунок 2.5 - Корреляция между статистическими признаками',
...
print(f"  Mean и другие: слабая связь (центрированные данные)")
...
if top_channels:
    ...
    axes[0].set_title(f'Рисунок 2.6 - Сглаживание RMS (Канал {best_channel})')
    axes[0].legend()
    ...
    axes[1].set_title(f'Рисунок 2.7 - Распределение шума (Канал {best_channel})')
...
print("  - set1_all_channels.png (Рис. 2.1)")
print("  - set1_top_channels.png (Рис. 2.2)")
print("  - set1_distributions.png (Рис. 2.3)")
print("  - set1_boxplot.png (Рис. 2.4)")
print("  - set1_correlation.png (Рис. 2.5)")
print("  - set1_noise_analysis.png (Рис. 2.6-2.7)")
print("  - set1_overall_statistics.csv (Табл. 2.2)")